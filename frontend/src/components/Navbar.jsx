...
//             style={{ background: "#4C4CFF", color: "white" }}
//         >
//             <h3 style={{ cursor: "pointer" }} onClick={() => history.push("/dashboard")}>
//                 HRMS
//             </h3>

//             <div className="d-flex gap-3">
//                 <button className="btn btn-light" onClick={() => history.push("/dashboard")}>Dashboard</button>
//                 <button className="btn btn-light" onClick={() => history.push("/employees")}>Employees</button>
//                 <button className="btn btn-light" onClick={() => history.push("/teams")}>Teams</button>
